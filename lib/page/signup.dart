  ...
  registration() async {
    if (password != null && name != null && email != null) {
      try {
        ...
        // ✅ ใช้ UID ของ Firebase แทน random string (จะตรงกับตอน login)
        ...
        if (e.code == 'weak-password') {
          ...
          showSnack("Registration failed. Try again.", Colors.redAccent);
        }
      }
    }
  }
  ...
  void showSnack(String text, Color color) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Text(text, style: const TextStyle(fontSize: 18.0, color: Colors.white)),
      ),
    );
  }
